...
public class Yttribumes {
    ...
    public static final Yttribume MODEL_SCALE = register(withAyamePath("model.scale"), new Yttribume(0.7F, 0.001F, 1000F, Yttribume.AttributeType.MODEL,false)); // 控制渲染缩放
